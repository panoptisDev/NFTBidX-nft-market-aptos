  ...
  return (
    <section className='max-w-5xl mx-auto bg-white/10 flex gap-5 justify-between px-10 items-center rounded max-md:flex-col'>
      <div className="flex flex-col gap-5 max-md:order-2 max-md:pb-5">
        ...
        <p className='text-white/50' data-aos="fade-right" data-aos-delay='50' data-aos-once>Stay updated with the latest news, exclusive offers, and upcoming NFT drops. Join our community of enthusiasts and never miss out!</p>
